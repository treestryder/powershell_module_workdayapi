...
'@ -f (Get-Date)
        ...
        It 'Throws an exception when an invalid phone number is supplied.' {
            { Set-WorkdayWorkerPhone -EmployeeId 1 -WorkPhone BadNumber} | Should Throw 'Unable to update Work phone number for EmployeeId: 1, invalid Phone Number: BadNumber'
        }
    }
}