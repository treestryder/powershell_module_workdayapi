...
'@ -f (Get-Date)
        ...
        It 'Throws an exception when an invalid email is supplied.' {
            { Set-WorkdayWorkerEmail -EmployeeId 1 -WorkEmail BadEmail } | Should Throw
        }
    }
}